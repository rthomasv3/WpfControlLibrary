...
namespace CodeCompendium.WpfControlLibrary
{
   ...
   public sealed class MainWindowViewModel : NotifyPropertyChanged
   {
      ...
      public MainWindowViewModel()
      {
         ...
         _tabs.Add(new GridViewModel("Grid", "The WPF Grid Control", "The grid control is used to layout controls in a grid format."));
         ...
         _tabs.Add(new ListBoxViewModel("ListBox", "The WPF ListBox Control", "The list box control is used to display a scrollable list of items to select."));
         _tabs.Add(new ListViewViewModel("ListView", "The WPF ListView Control", "The list view control is used to display a collection of items in different layouts."));
         ...
         _tabs.Add(new TextBlockViewModel("TextBlock", "The WPF TextBlock Control", "The text block control is used to display text on the screen."));
